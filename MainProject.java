...
public class MainProject extends Application {
	...
	Image img = new Image("Vaibhav.jpg");
        ...
        evenButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                highlightEvenNumbers(evenButton);
                fun(background);
            }
        });
         oddButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                highlightOddNumbers(oddButton);
                fun(background);
            }
        });
         primeButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                highlightPrimeNumbers(primeButton);
                fun(background);
            }
        });
        armstrongButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                highlightArmstrongNumbers(armstrongButton);
                fun(background);
            }
        });
         perfectButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                highlightPerfectNumbers(perfectButton);
                fun(background);
            }
        });
        // for making checkNumberBox
        VBox checkNumButtonBox = new VBox(200);
        numberCheck(checkNumButtonBox);
        ...
        buttonVBox.setPadding(new Insets(10, 20, 50, 20)); // Adjust padding as needed

        // Set the VBox with buttons to the left of the TextArea
        ...
        root.setRight(checkNumButtonBox);

        primaryStage.setScene(scene);
        primaryStage.show();
    }
/* */
    void numberCheck(VBox checkNumButtonBox){
       ...
       // VBox checkNumButtonBox = new VBox(200);
        ...
        checkNumButton.setPrefWidth(150); // Adjust the width as needed
        checkNumButton.setPrefHeight(70); 
        // Set the action to run when the button is clicked
        checkNumButton.setOnAction(e -> NumberCheck.RunCode());
         Insets buttonMargins = new Insets(0, 300, 100, 0); // Adjust the right margin as needed
    ...
    void fun(Background background){
 ...
 //       // Set the margins for the textArea
        ...
        rightVBox.getChildren().addAll(textArea);
